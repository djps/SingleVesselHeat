...
/**
	...
	\sa GenerateHeating()
*/
void GenerateHeating(int nx, int ny, int nz, double dx, double dy, double dz, Array3D<double> &heating, int num_heat_pars, double *heat_pars, int num_vel_pars, double *vel_pars, std::string &heatFileName);
